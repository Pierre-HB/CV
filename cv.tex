...
\title{Étudiant chercheur en informatique graphique}
...
\cvline{2021-2022}{étudiant master ENS (Lyon) (suivit du cours de CGDI)}
...
% \cventry{2023}{LIRIS}{Lyon}{3 mois}
% {Modélisation par surfaces implicites, avec GALIN Eric}{Stage ayant mené à trois découvertes significatives dans le domaine, une publication est en cours de rédaction.}
...
\cventry{2024}{Vision assisté par ordinateur}{Polytechnique (12h) M2}
{Assistant professeur}{}{}


% \begin{multicols}{2}
% %To set the doubleitem size:
